  ...
  return (
    <div className="w-full bg-gray-50 min-h-screen flex flex-col">
      {!open && (
        <>
          <Header />
          <div className="flex-1 py-8 px-4 sm:px-6 lg:px-8 flex justify-center">
            <div className="w-full max-w-4xl bg-white shadow-xl rounded-3xl overflow-hidden border border-gray-100 flex flex-col h-[80vh]">
              <div className="bg-gradient-to-r from-teal-600 to-emerald-600 px-6 py-5 shrink-0">
                ...
                <p className="text-teal-100 text-sm mt-1">Connect with your favorite shops</p>
              </div>
              <div className="flex-1 overflow-y-auto bg-gray-50/50 p-2">
                {conversations && conversations.length > 0 ? (
                  ...
                  <div className="h-full flex flex-col items-center justify-center text-gray-400">
                    ...
                    <p className="text-sm mt-1">When you contact a shop, your chats will appear here.</p>
                  </div>
                )}
              </div>
            </div>
      ...
      {open && (
        <div className="fixed inset-0 z-50 bg-gray-100 flex justify-center items-center p-0 sm:p-4 md:p-8">
           <div className="w-full h-full sm:max-w-4xl sm:max-h-[90vh] bg-white sm:rounded-3xl shadow-2xl overflow-hidden flex flex-col border border-gray-200">
              <SellerInbox
                setOpen={setOpen}
    ...
    >
      ...
      <div className="pl-4 flex-1 overflow-hidden">
        <div className="flex justify-between items-center mb-1">
          ...
          {/* Optional: Add timestamp here if available in data */}
        </div>
  ...
  return (
    <div className="w-full h-full flex flex-col bg-[#f0f2f5] relative">
      ...
      <div className="bg-white px-4 py-4 shrink-0 border-t border-gray-200">
        <form
          className="max-w-4xl mx-auto relative flex items-center gap-3 bg-gray-100 rounded-full pl-4 pr-2 py-1.5 focus-within:ring-2 focus-within:ring-teal-500/50 focus-within:bg-white transition-all shadow-inner"
        ...
        >
          <div className="shrink-0 flex items-center justify-center">
            ...
            />
            <label htmlFor="image" className="p-2 text-gray-400 hover:text-teal-600 hover:bg-teal-50 rounded-full cursor-pointer transition-colors">
              <TfiGallery size={22} />
            </label>
          </div>
          ...
          <button 
            ...
            className={`shrink-0 w-10 h-10 rounded-full flex items-center justify-center transition-all ${
              newMessage.trim() ? "bg-teal-600 text-white shadow-md hover:bg-teal-700 hover:scale-105" : "bg-gray-200 text-gray-400 cursor-not-allowed"
            }`}
          >
